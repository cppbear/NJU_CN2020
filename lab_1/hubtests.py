...
def hub_tests():
    ...
    # test case 4
    reqpkt = mk_pkt("30:00:00:00:00:02", "40:00:00:00:00:03",
                    "172.16.42.2", "172.16.52.4")
    s.expect(
        PacketInputEvent("eth0", reqpkt, display=Ethernet),
        "An Ethernet frame from 30:00:00:00:00:02 to 40:00:00:00:00:03 should arrive on eth0"
    )
    s.expect(
        PacketOutputEvent("eth1", reqpkt, "eth2", reqpkt, display=Ethernet),
        "Ethernet frame destined for 40:00:00:00:00:03 should be flooded out eth1 and eth2"
    )
    return s
